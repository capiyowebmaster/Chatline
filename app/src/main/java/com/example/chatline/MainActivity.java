...
import com.example.chatline.Fragments.DoneWith;
import com.example.chatline.Fragments.Friends;
import com.example.chatline.Fragments.Posts;
...
public class MainActivity extends AppCompatActivity  implements  NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (myModel.getStatusUrl().equals("statusUrl")){
                    navheaderImageView.setImageResource(R.mipmap.account_avatar_foreground);
                }
                else {
                ...
                if (myModel.getStatusUrl().equals("statusUrl")){
                    toobarImage.setImageResource(R.mipmap.accoint_avatar_foreground);
                }
                else {
                    Glide.with(MainActivity.this)
                            .load(myModel.getStatusUrl())
       ...
       viewpagerAdapter.addFragments(new Posts(),"Posts");
        viewpagerAdapter.addFragments(new Friends(),"Friends");
        viewpagerAdapter.addFragments(new Videos(),"Videos");
        viewpagerAdapter.addFragments(new DoneWith(),"DoneWith");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                break;
            case R.id.postImage:
                startActivity(new Intent(MainActivity.this, PostingMyImage.class));
                break;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.mystatus:
                startActivity(new Intent(MainActivity.this, PostingStatus.class));
                break;
            case R.id.settings:
