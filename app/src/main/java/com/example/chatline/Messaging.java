...
import com.example.chatline.Adapters.messagesAdapter;
import com.example.chatline.Models.imagesModel;
import com.example.chatline.Models.messageModel;
...
public class Messaging extends AppCompatActivity {
    ...
    public List  <imagesModel> models;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (myModel.getStatusUrl().equals("statusUrl")){
                    friendsImage.setImageResource(R.mipmap.account_avatar_foreground);
                }
                else {
